...
<html lang="en">
   ...
   <body>
               ...
               <div class="containt_main">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src="{{asset('userTemp/images/flag-uk.png')}}" alt="flag" class="mr-2 " title="United Kingdom"> English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="#" class="dropdown-item">
                           <img src="{{asset('userTemp/images/flag-france.png')}}" class="mr-2" alt="flag">
                           French
                           </a>
                        </div>
                     </div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="footer_logo"><a href="index.html"><img src="{{asset('userTemp/images/footer-logo.png')}}"></a></div>
            <div class="input_bt">
