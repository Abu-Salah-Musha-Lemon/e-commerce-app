...
<body>
			...
			<div class="header_section">
					<div class="container">
							<div class="containt_main">
									...
									<span class="toggle_icon" onclick="openNav()"><img src="{{ asset('userTemp/images/toggle-icon.png') }}"></span>
									<div class="dropdown">
													...
													<ul>
															@if (Route::has('login'))
																	@auth
																			@if ($roleId == 2)
																					<li>
																							<a href="{{ route('addToCart') }}">
																									...
																									<span class="padding_10 position-relative">Cart <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill">{{ $cardProductCount }}</span></span>
																							</a>
																					</li>
																			@endif
																			@if ($roleId == 1)
																			...
																			@elseif ($roleId == 2)
																					<li><a href="{{ route('userProfile') }}" class="text-white"><i class="fa fa-user" aria-hidden="true"></i> {{ $user->name }}</a></li>
																			@endif
																	@else
	...
	<div class="copyright_section">
			<div class="container">
					<p class="copyright_text">© {{ date('Y') }} All Rights Reserved. Developed by <a href="#">Abu Salah Musha Lemon</a></p>
			</div>
	</div>
