...
<html
  ...
  data-assets-path="{{asset('dashboards/assets/')}}"
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              <a href="{{route('adminDashboard')}}" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="dashboards">dashboardss</div>
              </a>
            </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('addCategory')}}" class="menu-link">
                    <div class="text-truncate" data-i18n="Without menu">Add Category</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('category')}}" class="menu-link">
                    <div class="text-truncate" data-i18n="Without navbar">All Category</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('subcategory.create')}}" class="menu-link">
                    <div class="text-truncate" data-i18n="Without menu">Add  Sub Category</div>
                  </a>
                </li>
                <li class="menu-item">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="{{route('profile.edit')}}"> <i class="bx bx-cog bx-md me-3"></i><span>Settings</span> </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="#">
