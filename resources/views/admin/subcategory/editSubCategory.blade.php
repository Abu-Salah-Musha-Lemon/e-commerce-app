...
<div class="row">
  ...
  <div class="col-xxl">
    <div class="card mb-6">
      ...
      <div class="card-body">
      <form action="{{ route('subcategory.update', $subcategory_info->id) }}" method="get">
      @csrf
          <div class="row mb-6">
            <div class="col-md-12">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control @error('subcategory_name') @enderror" name="subcategory_name"
                  placeholder="Enter Name" value="{{$subcategory_info->subcategory_name}}">
          ...
          <div class="row justify-content-center">
            <div class="col-sm-10 col-md-3">
              <button type="submit" class="btn btn-primary"><i class="bi bi-cloud-arrow-up"> </i> Update</button>
            </div>
          </div>
