                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group my-2">
                                <div class="input-group mb-3"
                                    ...
                                    <img id="image"
                                        src="{{ $product->product_img ? asset('storage/' . $product->product_img) : '' }}"
                                    ...
                                    <div class="fileUpload btn btn-success"
                                        ...
                                        <input type="file" name="product_img" id="product_img" accept="image/*" class="upload" style="display: none;" />
                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control @error('product_short_des') is-invalid @enderror" name="product_short_des"
                                    placeholder="Enter Short Description" value="{{ old('product_short_des', $product->product_short_des) }}" required>
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control @error('product_price') is-invalid @enderror" name="product_price"
                                    placeholder="Enter Price" value="{{ old('product_price', $product->product_price) }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="number" class="form-control @error('product_quantity') is-invalid @enderror" name="product_quantity"
                                    placeholder="Enter Quantity" value="{{ old('product_quantity', $product->product_quantity) }}" required>
