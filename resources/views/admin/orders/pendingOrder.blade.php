...
<div class="row">
  <div class="col-xl">
    ...
    @foreach($orderItems as $order)
        @if($order->Status === 'pending') <!-- Ensure the attribute name matches your model's attribute -->
            <tr>
                <td>{{ $s++ }}</td>
                ...
                <td>
                    <a href="{{ route('approveOrder', $order->id) }}" class="btn btn-outline-success">Approve Now</a>
                </td>
            </tr>
        @endif
    @endforeach
