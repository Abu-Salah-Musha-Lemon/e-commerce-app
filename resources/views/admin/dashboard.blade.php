...
<div class="page-content">
	@php
	// Import the Carbon library with an alias to avoid conflicts
	...
	$totalSalesToday = DB::table('Orders')->whereDate('created_at', $today)->count();

	// Calculate total sale amount today
	$totalSalesAmountToday = DB::table('Orders')->whereDate('created_at', $today)->sum('ProductPrice');

	// Additional metrics
	$totalCustomers = DB::table('Users')->count();
	$totalRevenueThisMonth = DB::table('Orders')->whereMonth('created_at', Carbon::now()->month)->sum('ProductPrice');
	$averageOrderValue = $totalSalesToday > 0 ? $totalSalesAmountToday / $totalSalesToday : 0;
	@endphp
	<!-- Dashboard Overview (Top-Level Metrics) -->
	<h5 class="fw-bold py-1 mb-1"> <span class='text-muted fw-light'>Dashboard Overview</span></h5>
	<section class="row">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="stats-icon purple">
										<img src="{{asset('dashboards/assets/img/icons/unicons/wallet-info.png')}}">
									</div>
								</div>
								<div class="col-md-8">
									<h6 class="text-muted font-semibold">Total Sales Today</h6>
									<h6 class="font-extrabold mb-0">{{ number_format($totalSalesAmountToday, 2) }}</h6>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="stats-icon blue">
										<img src="{{asset('dashboards/assets/img/icons/unicons/chart.png')}}">
									</div>
								</div>
								<div class="col-md-8">
									<h6 class="text-muted font-semibold">Total Orders Today</h6>
									<h6 class="font-extrabold mb-0">{{ $totalSalesToday }}</h6>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-body px-3 py-4-5">
							<div class="row">
								<div class="col-md-4">
									<div class="stats-icon red">
										<img src="{{asset('dashboards/assets/img/icons/unicons/cc-warning.png')}}">
									</div>
								</div>
								<div class="col-md-8">
									<h6 class="text-muted font-semibold">Total Revenue This Month</h6>
									<h6 class="font-extrabold mb-0">${{ number_format($totalRevenueThisMonth, 2) }}</h6>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body px-3 py-4-5">
							<div class="row">
								...
								<div class="col-md-8">
									...
									<h6 class="font-extrabold mb-0">${{ number_format($averageOrderValue, 2) }}</h6>
								</div>
							</div>
						</div>
					</div>
	...
	->select('ProductId', DB::raw('SUM(ProductQty) as total_quantity'))
	->groupBy('ProductId')
	...
	<h5 class="fw-bold py-1 mb-1"> <span class='text-muted fw-light'>Sales and Order Management</span></h5>
	<section class="row">
		<div class="col-12 col-lg-12">
			<div class="row">
					...
					<div class="card">
						<div class="card-body px-3 py-4-5">
							<div class="row">
								...
								<div class="col-md-8">
									<h6 class="text-muted font-semibold">Recent Orders (Last 10)</h6>
									<h6 class="font-extrabold mb-0">{{ $recentOrders->count() }}</h6>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-body px-3 py-4-5">
							<div class="row">
								...
								<div class="col-md-8">
									<h6 class="text-muted font-semibold">Top Selling Products</h6>
									<h6 class="font-extrabold mb-0">{{ $topSellingProducts->sum('total_quantity') }}</h6>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-body px-3 py-4-5">
							<div class="row">
								...
								<div class="col-md-8">
									<h6 class="text-muted font-semibold">Abandoned Carts</h6>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="table-responsive" style="margin: 4px;">
								<table id="dataTable" class="table table-striped table-bordered" style="padding-top: 5px;">
									<thead>
										<tr>
										Name	Customer Info	Product Name	Product Quantity	Product Price	
											<th> #</th>
											<th data-sortable="" style="width: 11.8408%;"><a href="#" class="dataTable-sorter">Name</a></th>
											<th data-sortable="" style="width: 41.8905%;"><a href="#" class="dataTable-sorter">Customer Info</a>
											</th>
											<th data-sortable="" style="width: 18.806%;"><a href="#" class="dataTable-sorter">Product Name</a></th>
											<th data-sortable="" style="width: 10.3184%;"><a href="#" class="dataTable-sorter">Product Quantity</a></th>
											<th data-sortable="" style="width: 10.1443%;"><a href="#" class="dataTable-sorter">Product Price</a>
											<th data-sortable="" style="width: 11.1443%;"><a href="#" class="dataTable-sorter text-center">Action</a>
											</th>
										</tr>
									</thead>
									<tbody>
       ...
       @php 
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="#" class="btn btn-outline-warning my-2">{{$order->Status}}</a>
										@else
                    <a href="#" class="btn btn-outline-success my-2">{{$order->Status}}</a>
@endif
                    <a href="{{ route('approveOrder', $order->id) }}" class="btn btn-outline-success">Approve</a>
                </td>
            </tr>
										...
										<div class="apexcharts-legend apexcharts-align-center position-bottom"
											...
											<div class="apexcharts-legend-series" rel="2" seriesname="Female" data:collapsed="false"
												style="margin: 2px 5px;"><span class="apexcharts-legend-marker" rel="2" data:collapsed="false"
													...
													class="apexcharts-legend-text" rel="2" i="1" data:default-text="Female" data:collapsed="false"
									...
									<g id="SvgjsG1266" class="apexcharts-inner apexcharts-graphical" transform="translate(12, 0)">
										<defs id="SvgjsDefs1265">
											...
											<filter id="SvgjsFilter1278" filterUnits="userSpaceOnUse" width="200%" height="200%" x="-50%"
												...
												<feComposite id="SvgjsFeComposite1280" in="SvgjsFeFlood1279Out" in2="SourceAlpha" operator="in"
													result="SvgjsFeComposite1280Out"></feComposite>
											...
											<filter id="SvgjsFilter1291" filterUnits="userSpaceOnUse" width="200%" height="200%" x="-50%"
												...
												<feComposite id="SvgjsFeComposite1293" in="SvgjsFeFlood1292Out" in2="SourceAlpha" operator="in"
													result="SvgjsFeComposite1293Out"></feComposite>
												...
												<g id="SvgjsG1273" class="apexcharts-slices">
													<g id="SvgjsG1274" class="apexcharts-series apexcharts-pie-series" seriesName="Male" rel="1"
														...
														<path id="SvgjsPath1275"
															...
															stroke-width="2" stroke-dasharray="0" class="apexcharts-pie-area apexcharts-donut-slice-0"
															index="0" j="0" data:angle="252" data:startAngle="0" data:strokeWidth="2" data:value="70"
													...
													<g id="SvgjsG1287" class="apexcharts-series apexcharts-pie-series" seriesName="Female" rel="2"
														data:realIndex="1">
														<path id="SvgjsPath1288"
															...
															stroke-width="2" stroke-dasharray="0" class="apexcharts-pie-area apexcharts-donut-slice-1"
															index="0" j="1" data:angle="108" data:startAngle="252" data:strokeWidth="2"
															data:value="30"
													...
													<g id="SvgjsG1276" class="apexcharts-datalabels"><text id="SvgjsText1277"
															...
															fill="#ffffff" class="apexcharts-text apexcharts-pie-label" filter="url(#SvgjsFilter1278)"
													...
													<g id="SvgjsG1289" class="apexcharts-datalabels"><text id="SvgjsText1290"
															...
															text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="600"
															fill="#ffffff" class="apexcharts-text apexcharts-pie-label" filter="url(#SvgjsFilter1291)"
